...
post_process.py
---------------
Post-process historical figures anachronism experiment results.
...
def main():
    parser = argparse.ArgumentParser(description="Post-process historical figures anachronism experiment results")
    ...
    json_files = sorted(results_dir.glob("historical_figures_batch_*.json"))
    if not json_files:
        print(f"No historical figures batch files found in {results_dir}")
        return
