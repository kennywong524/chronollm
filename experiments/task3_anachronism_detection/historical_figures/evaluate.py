...
evaluate.py
-----------
Compute evaluation metrics for the historical figures anachronism detection experiment.
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate historical figures anachronism detection results")
